...
$$ Y_t =  \beta_0 + \beta_{ozone} X_t + S_t + \delta t, $$ 
...
$$ y_t = \beta_0 + \beta_{ozone1} X_1 + \beta_{ozone2} X_2 + \beta_{ozone3} X_3 + ... + \beta_{ozone7} X_7, $$ 
and instead prefer to use a constrained non-linear function below    
$$ y_t = \beta_0 + f(x_{t};\beta), $$ 
...
Fitting the distributed lag model and generating estiamted lag effect 
```{r}
...
### Even better results than MOdel 5 above
